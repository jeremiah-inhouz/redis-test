...
kubectl set image deployment/redis-test-ms-deployment redis-test-ms="${IMAGE}:${SHA}" -n devubectl set image deployment/redis-test-ms-deployment redis-test-ms="${IMAGE}:${SHA}" -n dev
